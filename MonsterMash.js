...
require( ["js/qlik"], function ( qlik ) {
	...
	var app = qlik.openApp('cbf357b7-5a98-410e-a6f1-ea930cc27776', config);


	//get objects -- inserted here --
	app.getObject('QV05','agDefc');
	app.getObject('QV03','VfYx');
	
	
	app.getObject('QV04','b9d69a6a-3a47-43c1-9c89-dcdd6ffc0a7a');
	app.getObject('QV02','UmfPFzb');
	app.getObject('QV01','bMbEP');
